    ...
    await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        ...
        htmlContent: [
          ...
          "<p><strong>Tipologia:</strong> " + dati.tipologia + " &mdash; " + dati.stato + "</p>",
          "<p><strong>Superficie:</strong> " + dati.superficie_catastale + " mq catastali" + (dati.superficie_calpestabile ? " / " + dati.superficie_calpestabile + " mq calpestabili" : "") + "</p>",
          "<p><strong>Vani:</strong> " + (dati.vani || "—") + " | Camere: " + (dati.camere || "—") + " | Bagni: " + (dati.bagni || "—") + "</p>",
          "<p><strong>Cantina:</strong> " + (dati.cantina === "si" ? "S&igrave;" + (dati.cantina_mq ? " (" + dati.cantina_mq + " mq)" : "") : "No") + "</p>",
          "<p><strong>Garage:</strong> " + (dati.garage === "si" ? "S&igrave;" + (dati.garage_mq ? " (" + dati.garage_mq + " mq)" : "") : "No") + "</p>",
          "<p><strong>Prezzo desiderato:</strong> &euro; " + parseInt(dati.prezzo_desiderato).toLocaleString("it-IT") + "</p>",
          "<p><strong>Disponibilit&agrave; visite:</strong> " + (dati.disponibilita || "non specificata") + "</p>",
