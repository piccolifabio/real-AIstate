    ...
    <>
      ...
      <div className="faq-page">
        ...
        <nav className="faq-nav">
          <a href="/" className="faq-nav-logo">Real<span>AI</span>state</a>
          <a href="/" className="faq-nav-back">← Torna alla home</a>
        </nav>
        ...
        <footer className="faq-footer">
          <div className="faq-footer-logo">Real<span>AI</span>state</div>
          <div>© 2025 RealAIstate · realaistate.ai</div>
        </footer>
