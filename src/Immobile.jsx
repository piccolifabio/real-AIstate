...
const immobile = {
  id: 1,
  titolo: "Appartamento luminoso con terrazzo",
  zona: "Milano · Porta Romana",
  ...
  terrazzo: true,
  classe_energetica: "B",
  spese_condominio: 180,
  anno_costruzione: 1968,
  anno_ristrutturazione: 2019,
  scores: {
    prezzo: 82,
    investimento: 74,
    qualita: 91,
  },
  ai_summary: "Appartamento ben posizionato in una delle zone più ricercate di Milano, con un prezzo sostanzialmente allineato al mercato. La recente ristrutturazione e la classe energetica B lo rendono interessante sia per uso abitativo che come investimento. Attenzione alle spese condominiali — verificare la presenza di lavori straordinari in programma.",
  punti_forza: [
    "Classe energetica B — bollette contenute",
    "Ristrutturato nel 2019 — nessun intervento immediato",
    "Terrazzo privato di 14 mq",
    "Box auto incluso — raro in zona",
    "Zona in rivalutazione costante",
  ],
  criticita: [
    "Anno di costruzione 1968 — verificare impianti",
    "Spese condominiali non dettagliate",
    "Piano intermedio — no vista panoramica",
  ],
  domande: [
    "Ci sono lavori straordinari in programma o deliberati in condominio?",
    "Gli impianti elettrico e idraulico sono stati rifatti nel 2019?",
    "Qual è la composizione esatta delle spese condominiali?",
    "Il box è in proprietà o in uso esclusivo?",
    "L'appartamento è stato abitato recentemente o è libero da tempo?",
  ],
  documenti: [
    { nome: "Visura Catastale", verificato: true },
    { nome: "Planimetria Catastale", verificato: true },
    { nome: "APE — Classe Energetica", verificato: true },
  ...
  comparabili: [
    { indirizzo: "Via Lamarmora, 8", mq: 88, prezzo: 510000, locali: 3, delta: "higher" },
    { indirizzo: "Corso di Porta Romana, 45", mq: 95, prezzo: 470000, locali: 3, delta: "lower" },
    { indirizzo: "Via Corridoni, 22", mq: 90, prezzo: 490000, locali: 3, delta: "similar" },
  ],
};
          ...
          <div className="sticky-card">
            ...
            <div className="sticky-card-body">
              {[
                ...
                ["Garage", immobile.garage ? "Incluso" : "No"],
