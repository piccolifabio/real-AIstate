      ...
      <>
        ...
        <div className="vendi-page">
          <div className="vendi-hero">
            ...
            <p className="vendi-sub">Niente agenzia. L'AI confronta il tuo prezzo con i dati ufficiali OMI, analizza le tue foto, pubblica il tuo annuncio. Noi ti diamo gli strumenti, tu decidi.</p>
          </div>
