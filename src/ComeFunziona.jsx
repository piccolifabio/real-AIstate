  ...
  return (
    <>
      ...
      <nav className="cf-nav">
        <a href="/" className="cf-nav-logo">Real<span>AI</span>state</a>
        <div className="cf-nav-links">
          <a href="/faq" className="cf-nav-link">FAQ</a>
          <a href="/scuse" className="cf-nav-link">Le scuse</a>
          <a href="/vendi" className="cf-nav-cta">Vendi casa</a>
        </div>
      </nav>
      ...
      <footer className="cf-footer">
        <div className="cf-footer-logo">Real<span>AI</span>state</div>
